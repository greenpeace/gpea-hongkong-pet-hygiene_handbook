...
var _mailcheckMin = _interopRequireDefault(require("./mailcheck.min.js"));
...
(0, _jquery.default)(function () {
  const email = (0, _jquery.default)("#email");
  const emailField = (0, _jquery.default)(".form-group--email");
  const btnDownload = (0, _jquery.default)(".btn--download"); //
  ...
  email.on("blur", function () {
    (0, _jquery.default)(this).Mailcheck({
      domains: domains,
      // optional
      ...
      // optional
      suggested: function (element, suggestion) {// callback code
      },
      empty: function (element) {// callback code
      }
    });
  });
...
},{"sanitize.css/sanitize.css":"0662f0063827c0c9171e092aeafdfddf","./main.scss":"a3ac74168a2fd8188e272f6a6869a52a","jquery":"ff25de20f998fe8be9b0cd7686e4212b","validate.js":"7b5128bcd0b1981b168e1686bdc8f372","./mailcheck.min.js":"df76686170f1f1d4934ca2645417fd0e"}],"0662f0063827c0c9171e092aeafdfddf":[function() {},{}],"a3ac74168a2fd8188e272f6a6869a52a":[function() {},{}],"ff25de20f998fe8be9b0cd7686e4212b":[function(require,module,exports) {
var define;
/*!
...
},{}],"7b5128bcd0b1981b168e1686bdc8f372":[function(require,module,exports) {
var define;
/*!
 * validate.js 0.13.1
 *
...
},{}],"df76686170f1f1d4934ca2645417fd0e":[function(require,module,exports) {
/*1.1.0*/
var Mailcheck = {
  domainThreshold: 4,
  topLevelThreshold: 3,
  ...
  suggest: function (a, b, c, d) {
    ...
    if (b = this.findClosestDomain(a.domain, b, d, this.domainThreshold)) {
      if (b != a.domain) return {
        address: a.address,
        domain: b,
        full: a.address + "@" + b
      };
    } else if (c = this.findClosestDomain(a.topLevelDomain, c, d, this.topLevelThreshold), a.domain && c && c != a.topLevelDomain) return d = a.domain, b = d.substring(0, d.lastIndexOf(a.topLevelDomain)) + c, {
      address: a.address,
      domain: b,
      full: a.address + "@" + b
    };
...
//# sourceMappingURL=main.5ec8a370.js.map
