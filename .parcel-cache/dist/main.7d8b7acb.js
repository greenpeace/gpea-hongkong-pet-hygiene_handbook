...
(0, _jquery.default)(function () {
  ...
  var emailField = document.querySelector(".form-group--email");
  ...
  console.log(_mailcheck.default);
  email.addEventListener("blur", function () {
    console.log(email.value);

    _mailcheck.default.run({
      email: email.value,
      suggested: function (suggestion) {// callback code
      },
...
//# sourceMappingURL=main.7d8b7acb.js.map
